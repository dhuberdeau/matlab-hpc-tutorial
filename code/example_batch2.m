...
% Save plot to PDF
saveas(f, 'example4-2dplot.pdf');

% Also save plot to black and white EPS, with 300 DPI
dateaxis('x', 6);
print(f, '-deps', '-r300', 'example4-2dplot.eps');
...
print(f, '-depsc', '-r300', 'example4-scatter.eps');
